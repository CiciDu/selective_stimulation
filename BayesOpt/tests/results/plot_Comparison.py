...
names = ['vae_bo'] + ['NNKL_bo'] + ['FullNNKL_bo'] + ['add_bo'] + ['rembo']
labels = ['VAE-BO'] + ['NNC-BO'] + ['MGPC-BO'] + ['ADD-BO'] + ['REMBO']
colors = ['darkorange'] + ['red'] + ['blue'] + ['magenta'] + ['aqua']
linestyles = ['--'] + ['--'] + ['-'] + ['--'] + ['--']
...
ax = plot_threshold(ax, xiterations, threshold=objective.fmin,
                    label='fmin', linestyle='--', color='k')
