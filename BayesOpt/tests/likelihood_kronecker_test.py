...
class manifold_bo_optimizer(optimizer):
    ...
    def initialize_modelM(self):
        ...
        np.random.seed(23)
        coreg.W = np.random.randn(
            self.Xnorm.shape[1] + 1, self.Xnorm.shape[1] + 1)
...
defaults = ['0', 'ProductSines10D', 'manifold_bo', 'Neg_ei', int(10), int(
    100), int(50)]    # list ints, name_objective, name_optimizer, name loss
